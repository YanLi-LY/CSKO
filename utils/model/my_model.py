...
class my_model(ExemplarHandler):
    def __init__(self, backbone=None, pretrained=False, args=None):
        ...
        self.backbone = backbone(pretrained=pretrained, mode=args.mode, args=args)
    ...
    def fix_backbone_part(self):
        for k, v in self.backbone.named_parameters():
            if 'layer4.1.conv2.conv.weight' in k or 'layer4.1.conv1.conv.weight' in k:
