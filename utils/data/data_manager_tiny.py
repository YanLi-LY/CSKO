...
class tinyImageNet(object):
    def download_data(self, args):
        ...
        test_dir = os.path.join(args.data_dir, args.dataset_name, 'test')
        ...
        for item in train_dset.imgs:
            train_images.append(item[0]) # item[0]: (str) image path
            train_labels.append(item[1]) # item[1]: (int) label
